...
module.exports = function (app) {
  ...
  app.route('/api/check')
    .post((req, res) => {
      ...
      validReg=solver.checkRegionPlacement(puzzle,row,column,value),
      validRow=solver.checkRowPlacement(puzzle,row,column,value),
      conflicts=[];
      if(validCol&&validReg&&validRow) res.json({valid:true});
      else{
  ...
  app.route('/api/solve')
    .post((req, res) => {
      ...
      else res.json({solution:solvedString});
    });
};
